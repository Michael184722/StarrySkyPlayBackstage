<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="交易场所：1-商城、2-全局套，3-打拳套，4-无限池，5-攀塔，9-积分池" prop="floor">
        <el-input
          v-model="queryParams.floor"
          placeholder="请输入交易场所：1-商城、2-全局套，3-打拳套，4-无限池，5-攀塔，9-积分池"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="交易积分" prop="integral">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['integralRecord:integralRecord:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['integralRecord:integralRecord:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['integralRecord:integralRecord:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['integralRecord:integralRecord:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="integralRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="交易场所：1-商城、2-全局套，3-打拳套，4-无限池，5-攀塔，9-积分池" align="center" prop="floor" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="交易场所：1-商城、2-全局套，3-打拳套，4-无限池，5-攀塔，9-积分池" prop="floor">
          <el-input v-model="form.floor" placeholder="请输入交易场所：1-商城、2-全局套，3-打拳套，4-无限池，5-攀塔，9-积分池" />
        </el-form-item>
        <el-form-item label="交易金额" prop="money">
          <el-input v-model="form.money" placeholder="请输入交易金额" />
        </el-form-item>
        <el-form-item label="交易积分" prop="integral">
          <el-input v-model="form.integral" placeholder="请输入交易积分" />
        </el-form-item>
        <el-form-item label="商品id(多个用逗号分割)" prop="commodityId">
...
<script>
import { listIntegralRecord, getIntegralRecord, delIntegralRecord, addIntegralRecord, updateIntegralRecord } from "@/api/integralRecord/integralRecord";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户积分记录编号为"' + ids + '"的数据项？').then(function() {
        return delIntegralRecord(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('integralRecord/integralRecord/export', {
        ...this.queryParams
