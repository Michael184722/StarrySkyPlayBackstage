<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['bagRecord:bagRecord:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['bagRecord:bagRecord:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['bagRecord:bagRecord:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bagRecord:bagRecord:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="bagRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态：0-未使用 1-已使用" align="center" prop="status" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除福袋赠送记录编号为"' + ids + '"的数据项？').then(function() {
