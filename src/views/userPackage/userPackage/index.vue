<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['userPackage:userPackage:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['userPackage:userPackage:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['userPackage:userPackage:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['userPackage:userPackage:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="userPackageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态：0-正常  1-交易区发布状态 2-发货状态" align="center" prop="status" />
...
<script>
import { listUserPackage, getUserPackage, delUserPackage, addUserPackage, updateUserPackage } from "@/api/userPackage/userPackage";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户背包信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('userPackage/userPackage/export', {
        ...this.queryParams
